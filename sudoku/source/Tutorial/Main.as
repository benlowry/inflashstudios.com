package Tutorial
{
	...
	public class Main extends MovieClip
	{
		...
		Pages[6] = new Tutorial.Part2A();
		Pages[7] = new Tutorial.Part2B();
		Pages[8] = new Tutorial.Part2C();
		Pages[9] = new Tutorial.Part2D();
		Pages[10] = new Tutorial.Part2E();
		Pages[11] = new Tutorial.Part2F();
		Pages[12] = new Tutorial.Part2G();
		Pages[13] = new Tutorial.Part2H();
		Pages[14] = new Tutorial.Part2I();
		Pages[15] = new Tutorial.Part2J();
		Pages[16] = new Tutorial.Part2K();
		Pages[17] = new Tutorial.Part3A();
		Pages[18] = new Tutorial.Part3B();
		Pages[19] = new Tutorial.Part3C();
		Pages[20] = new Tutorial.Part3D();
		Pages[21] = new Tutorial.Part3E();
		Pages[22] = new Tutorial.Part3F();
				
		private static const Menu:Array = new Array();
		Menu[0] = new Tutorial.MenuButton("Introduction", 1);
		Menu[1] = new Tutorial.MenuButton("Setting up our Flash file", 1);
		Menu[2] = new Tutorial.MenuButton("The background", 1);
		Menu[3] = new Tutorial.MenuButton("The grid background", 1);
		Menu[4] = new Tutorial.MenuButton("The interface", 1);
		Menu[5] = new Tutorial.MenuButton("Our win dialogue", 1);
		Menu[6] = new Tutorial.MenuButton("Creating the code", 1);
		
		Menu[7] = new Tutorial.MenuButton("Setting up Game.as", 2);
		Menu[8] = new Tutorial.MenuButton("Properties", 2);
		Menu[9] = new Tutorial.MenuButton("Methods", 2);
		Menu[10] = new Tutorial.MenuButton(" - Starting a game", 2);
		Menu[11] = new Tutorial.MenuButton(" - Generating a puzzle", 2);
		Menu[12] = new Tutorial.MenuButton("    - Checking for conflicts", 2);
		Menu[13] = new Tutorial.MenuButton(" - Hints", 2);
		Menu[14] = new Tutorial.MenuButton("    - Available Cells", 2);
		Menu[15] = new Tutorial.MenuButton(" - Checking for a win", 2);
		Menu[16] = new Tutorial.MenuButton(" - Solving, and Random", 2);
		
		Menu[17] = new Tutorial.MenuButton("Setting up Cell.as", 3);
		Menu[18] = new Tutorial.MenuButton("Properties", 3);
		Menu[19] = new Tutorial.MenuButton("Methods", 3);
		Menu[20] = new Tutorial.MenuButton(" - Highlight / unhighlight cells", 3);
		Menu[21] = new Tutorial.MenuButton(" - Typing, and Resetting", 3);
		Menu[22] = new Tutorial.MenuButton(" - Show / Get answers", 3);		
