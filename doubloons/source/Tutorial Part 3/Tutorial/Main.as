package Tutorial
{
	...
	public class Main extends MovieClip
	{
		...
		Pages[7] = new Tutorial.Part2A();
		Pages[8] = new Tutorial.Part2B();
		Pages[9] = new Tutorial.Part3A();
		Pages[10] = new Tutorial.Part3B();		
	
						
		private static const Menu:Array = new Array();
		Menu[0] = new Tutorial.MenuButton("Introduction", 1);		
		Menu[1] = new Tutorial.MenuButton("The starting screen", 1);	
		Menu[2] = new Tutorial.MenuButton("Level select screen pt 1", 1);			
		Menu[3] = new Tutorial.MenuButton("Level select screen pt 2", 1);
		Menu[4] = new Tutorial.MenuButton("Restart screen", 1);
		Menu[5] = new Tutorial.MenuButton("Next level screen", 1);		
		Menu[6] = new Tutorial.MenuButton("The win screen", 1);
		
		Menu[7] = new Tutorial.MenuButton("Save manager", 2);
		Menu[8] = new Tutorial.MenuButton("Sound manager", 2);

		Menu[9] = new Tutorial.MenuButton("Creating levels pt 1", 3);
		Menu[10] = new Tutorial.MenuButton("Creating levels pt 2", 3);
