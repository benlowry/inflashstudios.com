package Tutorial
{
	...
	public class Main extends MovieClip
	{
		...
		Pages[8] = new Tutorial.Part2A();
		Pages[9] = new Tutorial.Part2B();
		Pages[10] = new Tutorial.Part2C();		
		Pages[11] = new Tutorial.Part2D();		
						
		private static const Menu:Array = new Array();
		Menu[0] = new Tutorial.MenuButton("Introduction", 1);		
		Menu[1] = new Tutorial.MenuButton("Our document class pt 1", 1);	
		Menu[2] = new Tutorial.MenuButton("Our document class pt 2", 1);			
		Menu[3] = new Tutorial.MenuButton("Rotating the cannon", 1);
		Menu[4] = new Tutorial.MenuButton("Loading the cannon", 1);
		Menu[5] = new Tutorial.MenuButton("Firing the cannon", 1);		
		Menu[6] = new Tutorial.MenuButton("Sound and restarting", 1);
		Menu[7] = new Tutorial.MenuButton("The game loop", 1);
		
		Menu[8] = new Tutorial.MenuButton("The water", 2);
		Menu[9] = new Tutorial.MenuButton("The clouds pt 1", 2);
		Menu[10] = new Tutorial.MenuButton("The clouds pt 2", 2);		
		Menu[11] = new Tutorial.MenuButton("The seagulls", 2);
